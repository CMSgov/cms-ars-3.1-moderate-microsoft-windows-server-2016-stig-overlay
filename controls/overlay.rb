include_controls 'microsoft-windows-server-2016-stig-baseline' do
  ...
  control 'V-73283' do
    title "Windows Server 2016 must automatically remove or disable temporary user accounts after 60 days."
  ...
  control 'V-73307' do
    ...
    desc "check", 'Review the Windows time service configuration. Open an elevated "Command Prompt" (run as administrator). Enter "W32tm /query /configuration".
  ...
  control 'V-73309' do
    ...
    If \"LockoutDuration\" is less than \"60\" minutes (excluding \"0\") in the file, this is a finding.
  ...
  control 'V-73649' do
    ...
    desc "fix", "Configure the policy value for Computer Configuration >> Windows Settings >> Security Settings >> Local Policies >> Security Options >> \"Interactive Logon: Message title for users attempting to log on\" to \"CMS Notice and Consent Banner\", \"US Department of Health and Human Services Warning Statement\", or
